...
class supplierClass:
    def __init__(self, root):
        ...
        #===title===
        title=Label(self.root,text="Supplier Details",font=("goudy old style",20,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=10,width=1175,height=40)
        ...
        emp_frame.place(x=700,y=120,width=500,height=500)
